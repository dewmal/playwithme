...
export default function App() {
  ...
  const startRecording = async () => { try { await recorder.start(recordingReset); } catch (error) { notify(error instanceof Error ? error.message : "Microphone access was not granted", 8000); } };
